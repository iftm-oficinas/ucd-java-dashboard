                                                ...
                                                <tbody>
                                                    <c:forEach var="complaint" items="${complaintList}">
                                                        <tr>
                                                            ...
                                                            <td width="100px">
                                                                <a href="/ucd/complaint/edit?idComplaint=${complaint.id}" type="button" class="btn btn-white btn-xs"><i class="fa fa-pencil"></i></a>
                                                                <a href="/ucd/complaint/destroy?idComplaint=${complaint.id}" type="button" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                                                <a href="/ucd/complaint/inspect?idComplaint=${complaint.id}" type="button" class="btn btn-success btn-xs"><i class="fa fa-check"></i></a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
