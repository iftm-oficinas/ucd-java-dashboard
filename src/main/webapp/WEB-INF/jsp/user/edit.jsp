...
<html>
    ...
    <body>
                                                ...
                                                <div class="col-sm-12 b-r">
                                                    <form role="form" action="/ucd/user/update" method="POST">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Nome</label>
                                                            <input type="text" placeholder="Nome" class="form-control" name="user.name" value="${user.name}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Email</label>
                                                            <input type="email" placeholder="Email" class="form-control" name="user.email" value="${user.email}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Senha</label>
                                                            <input type="password" placeholder="Senha" class="form-control" name="user.password" value="${user.password}">
                                                        </div>
                                                        <div>
                                                            ...
                                                            <label>
                                                                <c:if test="${user.inspector == 1}">
                                                                    <input type="checkbox" name="user.inspector" value="1" checked="checked"> Inspetor?                                                                
                                                                </c:if>

                                                                <c:if test="${user.inspector != 1}">
                                                                    <input type="checkbox" name="user.inspector" value="0"> Inspetor?                                                               
                                                                </c:if>
        ...
        <script src="../resources/peity.js"></script>
